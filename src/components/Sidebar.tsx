      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <div className="flex items-center justify-center space-x-3">
            <img src={Comecari} alt="Logo" className='w-[55px]' />
            <span className='text-2xl text-white'>Comecari</span>
          </div>
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/fleets' || pathname.includes('fleets')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <NavLink
                  to="/bids"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('bids') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
